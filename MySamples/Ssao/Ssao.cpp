    ...
    UINT rtvDescriptorSize)
{
    ...
    RebuildDescriptors(depthStencilBuffer, gBuffer);
}

void Ssao::RebuildDescriptors(ID3D12Resource* depthStencilBuffer, GBuffer* gBuffer)
{
    ...
    md3dDevice->CreateShaderResourceView(gBuffer->NormalMap(), &srvDesc, mhNormalMapCpuSrv);

    // TODO: stop hard-coding the format.
...
void Ssao::BuildResources()
{
    ...
    CD3DX12_CLEAR_VALUE optClear(Ssao::AmbientMapFormat, ambientClearColor);
